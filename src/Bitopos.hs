...
Ссылки: топология Скотта и непрерывные решётки — Gierz et al., "Continuous
Lattices and Domains"; битопологическая природа (d-frames) — Jung-Moshier (2006);
FOUR и билатисы — Belnap (1977), Ginsberg, Fitting. Вывод Bel <= Pl и tot-волокно
(наше) — PytevIso.ipynb, разделы 6-7.
